...
function createOrg2() {
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:$port --caname ca-$org -M "${PWD}/organizations/peerOrganizations/$org.example.com/peers/peer0.$org.example.com/msp" --csr.hosts peer0.$org.example.com --tls.certfiles "${PWD}/organizations/fabric-ca/$org/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:$port --caname ca-$org -M "${PWD}/organizations/peerOrganizations/$org.example.com/peers/peer0.$org.example.com/tls" --enrollment.profile tls --csr.hosts peer0.$org.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/$org/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:$port --caname ca-$org -M "${PWD}/organizations/peerOrganizations/$org.example.com/users/User1@$org.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/$org/ca-cert.pem"
  { set +x; } 2>/dev/null
